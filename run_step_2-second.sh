...
OUTPUT_DIR=/Prove/Yoshihisa/HEIF_ghost/PKL/pkl_second

source "/data/lesc/staff/yoshihisa/anaconda3/etc/profile.d/conda.sh"

./2-creating_data.py -l "$LIBHEIF_PATH" -c "$CONVERT_PATH" -i "$INPUT_DIR" -o "$OUTPUT_DIR" run-second ${SLURM_ARRAY_TASK_ID}
